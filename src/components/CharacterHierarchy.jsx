        ...
        return (
          <div key={rank} className="flex flex-col items-center w-full">
            ...
            <button
              ...
              className="bg-gold text-wood px-4 py-2 rounded-lg font-medieval font-bold mb-3 hover:bg-gold-dark transition shadow-lg border-2 border-gold-dark"
            >
              {rank} ({groupedByRank[rank].length})
            </button>

            {/* Connection line down from rank */}
            {isExpanded && groupedByRank[rank].length > 0 && (
